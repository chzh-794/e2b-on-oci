...
func (o *OCIBucketStorageProvider) DeleteObjectsWithPrefix(ctx context.Context, prefix string) error {
	...
	for {
		...
		if resp.ListObjects.NextStart == nil || *resp.ListObjects.NextStart == "" {
			break
		}
		start = *resp.ListObjects.NextStart
	}
...
func (o *OCIBucketStorageProvider) OpenObject(ctx context.Context, path string) (*OCIBucketStorageObjectProvider, error) {
